// Easing functions from https://github.com/ai/easings.net
const pow = Math.pow;
...
export function ease(progress: number, easingName: keyof typeof easings) {
  return easings[easingName](progress);
}
